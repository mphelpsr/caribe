...
var getCollection = function(self, name, options, callback) {
 ...
 * @return {Promise} returns Promise if no callback passed
 */
Db.prototype.getCollection = function(name, options, callback) {
  var self = this;
  ...
  if(typeof callback == 'function') return getCollection(self, name, options, callback);
  return new this.s.promiseLibrary(function(resolve, reject) {
    getCollection(self, name, options, function(err, r) {
      if(err) return reject(err);
      resolve(r);
    });
  });
...
define.classMethod('getCollection', {callback: true, promise:true});
